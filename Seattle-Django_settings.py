...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/home/ch/deployment/clearinghouse/website/log.log',
            'formatter':'verbose',
        },
    },
    'loggers': {
